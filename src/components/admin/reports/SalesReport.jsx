...
export default function SalesReport() {
  ...
  const { data: sales = [], isLoading: ls } = useQuery({ queryKey: ['rpt-sales'], queryFn: () => listSales() });
  const { data: orders = [], isLoading: lo } = useQuery({ queryKey: ['rpt-orders'], queryFn: () => listOrders() });
